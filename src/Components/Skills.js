...
export default function Skills() {
    ...
    return (
        ...
        <section id="skills" className="container mx-auto flex px-10 py-60 flex-col" >
            ...
            {skills.map(skill => (
                <div key={skill.id} className=" flex title-font items-center sm:text-xl text-3xl mb-4 font-medium text-gray-400">
                    <div className="w-60 p-4 mr-4  sm:text-2xl text-2xl mb-4">
                        <p>{skill.title}</p>
                    </div>
                    <div class=" flex items-start flex-col fade-in">
                    
                        <ul className="p-4 list-inside  mr-20 list-none flex justify-center text-xl ">
